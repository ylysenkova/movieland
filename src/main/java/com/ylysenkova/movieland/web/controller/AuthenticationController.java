...
import com.ylysenkova.movieland.web.response.AuthenticationResponse;
import com.ylysenkova.movieland.web.response.TextMessageResponse;
...
public class AuthenticationController {
    ...
    public @ResponseBody ResponseEntity<?> logout (@RequestHeader("x-auth-token") String uuid) {
